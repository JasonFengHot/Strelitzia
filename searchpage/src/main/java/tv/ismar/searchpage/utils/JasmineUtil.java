...
public class JasmineUtil {
    ...
    public static void scaleOut2(View view){

        Animator animator= AnimatorInflater.loadAnimator(view.getContext(), R.animator.scaleout_subject);
        animator.setTarget(view);
        animator.start();
    }
    public static void scaleIn2(View view){

        Animator animator= AnimatorInflater.loadAnimator(view.getContext(), R.animator.scalein_subject);
        animator.setTarget(view);
        animator.start();
    }

    public static void scaleOut3(View view){

        Animator animator= AnimatorInflater.loadAnimator(view.getContext(), R.animator.scaleout_recommend_poster);
        animator.setTarget(view);
        animator.start();
    }
    public static void scaleIn3(View view){

        Animator animator= AnimatorInflater.loadAnimator(view.getContext(), R.animator.scalein_recomment_poster);
        animator.setTarget(view);
        animator.start();
    }
