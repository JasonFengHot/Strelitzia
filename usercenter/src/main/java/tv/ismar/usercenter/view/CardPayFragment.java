...
public class CardPayFragment extends Fragment implements View.OnClickListener, OnHoverListener {
    ...
    public void onAttach(Activity activity) {
        ...
        skyService = ((UserCenterActivity) activity).mSkyService;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        contentView = inflater.inflate(tv.ismar.pay.R.layout.fragmet_cardpay, null);
        submitBtn = (Button) contentView.findViewById(tv.ismar.pay.R.id.shiyuncard_submit);
        cardNumberEdt = (EditText) contentView.findViewById(tv.ismar.pay.R.id.shiyuncard_input);
        submitBtn.setOnClickListener(this);
        rechargeMsgTextView = (TextView) contentView.findViewById(tv.ismar.pay.R.id.recharge_error_msg);
        submitBtn.setNextFocusLeftId(R.id.usercenter_card);
        cardNumberEdt.setNextFocusLeftId(R.id.usercenter_card);
        return contentView;
    }
                            ...
                            case "S":
                                ...
                                if (!TextUtils.isEmpty(flag) && "usercenter_charge".equals(flag)) {
                                 //   mPaymentActivity.sendLog();
                                    mUserCenterActivity.cardActiveSuccess();
                                }
                                break;
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == tv.ismar.pay.R.id.shiyuncard_submit) {
