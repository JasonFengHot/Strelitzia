...
/*modify by dragontec for bug 4332 end*/
	...
	protected void unInitListener() {
		mTvPlayerLayoutManager.setFocusSearchFailedListener(null);
...
/*modify by dragontec for bug 4057 end*/
	...
	public void onClick(View v) {
		...
		if (i == R.id.navigation_left) {
			...
			if (mTvPlayerLayoutManager.findFirstCompletelyVisibleItemPosition() > 0) {
...
//			}
			...
			if (mTvPlayerLayoutManager.findLastCompletelyVisibleItemPosition() <= mFetchControl.getHomeEntity(mBannerPk).count) {
				mTvPlayerLayoutManager.setCanScroll(true);
				mRecyclerView.loadMore();
				int targetPosition = mTvPlayerLayoutManager.findLastCompletelyVisibleItemPosition() + 4;
				if (targetPosition > mTvPlayerLayoutManager.getItemCount() - 1) {
					targetPosition = mTvPlayerLayoutManager.getItemCount() - 1;
				}
				setNeedCheckScrollEnd();
				mTvPlayerLayoutManager.smoothScrollToPosition(mRecyclerView, null, targetPosition);
			}
...
//					<= mTvPlayerLayoutManager.getItemCount() - 1) {
//				int targetPosition = mTvPlayerLayoutManager.findLastCompletelyVisibleItemPosition() + 4;
//				if (targetPosition > mTvPlayerLayoutManager.getItemCount() - 1) {
//					targetPosition = mTvPlayerLayoutManager.getItemCount() - 1;
//				}
