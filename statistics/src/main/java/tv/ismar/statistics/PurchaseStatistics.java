...
public class PurchaseStatistics {
    ...
    public void expensePageExit(
        ...
        dataCollectionProperties.put("page", AppConstant.purchase_entrance_page);
        dataCollectionProperties.put("channel", AppConstant.purchase_entrance_channel);
        dataCollectionProperties.put("keyword", AppConstant.purchase_entrance_keyword);
        dataCollectionProperties.put("related_item", AppConstant.purchase_entrance_related_item);
        dataCollectionProperties.put("related_title", AppConstant.purchase_entrance_related_title);
        dataCollectionProperties.put("related_channel", AppConstant.purchase_entrance_channel);
        dataCollectionProperties.put("tab", AppConstant.purchase_tab);
        dataCollectionProperties.put("location", AppConstant.purchase_tab);
